...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=libcan/can.c libpicutil/time.c libpicutil/uart_debug.c main.c encoders.c motors.c solenoids.c libpicutil/adc.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/libcan/can.p1 ${OBJECTDIR}/libpicutil/time.p1 ${OBJECTDIR}/libpicutil/uart_debug.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/encoders.p1 ${OBJECTDIR}/motors.p1 ${OBJECTDIR}/solenoids.p1 ${OBJECTDIR}/libpicutil/adc.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/libcan/can.p1.d ${OBJECTDIR}/libpicutil/time.p1.d ${OBJECTDIR}/libpicutil/uart_debug.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/encoders.p1.d ${OBJECTDIR}/motors.p1.d ${OBJECTDIR}/solenoids.p1.d ${OBJECTDIR}/libpicutil/adc.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/libcan/can.p1 ${OBJECTDIR}/libpicutil/time.p1 ${OBJECTDIR}/libpicutil/uart_debug.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/encoders.p1 ${OBJECTDIR}/motors.p1 ${OBJECTDIR}/solenoids.p1 ${OBJECTDIR}/libpicutil/adc.p1

# Source Files
SOURCEFILES=libcan/can.c libpicutil/time.c libpicutil/uart_debug.c main.c encoders.c motors.c solenoids.c libpicutil/adc.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/encoders.p1: encoders.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/encoders.p1 encoders.c 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/EngineValveRCU-sw.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
