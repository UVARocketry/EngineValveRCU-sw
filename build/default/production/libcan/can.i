...
void __attribute__((picinterrupt(("irq(40)")))) RXB0_int() {
    PIR5bits.RXB0IF = 0;
...
void __attribute__((picinterrupt(("irq(42)")))) TXB0_int() {
    PIR5bits.TXB0IF = 0;
