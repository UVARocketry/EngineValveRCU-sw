...
# 1 "./libpicutil/time.h" 1
# 14 "./libpicutil/time.h"
void time_init(void);
uint16_t time_millis(void);
uint16_t time_secs(void);

void (*one_kHz_callback)(void);
# 18 "main.c" 2

# 1 "./libpicutil/uart_debug.h" 1
# 16 "./libpicutil/uart_debug.h"
void uart_init(void);
...
# 1 "./libcan/can.h" 1
# 11 "./libcan/can.h"
# 1 "./libcan/can_messages.h" 1
# 13 "./libcan/can_messages.h"
typedef struct {
...
Motor_t ox_main = {.which = 1};
Motor_t fuel_press = {.which = 2};
...
int main() {
    ...
    one_kHz_callback = &encoders_update;
    time_init();
    uart_init();
...
# 80 "main.c"
    ...
    while (1) {
        ...
        if (time_millis() - last_10Hz_time > 100) {
            ...
            can_txq_push(0x200 | 2, sizeof (MotorStatus_t), (uint8_t*)&ox_main.status);
            can_txq_push(0x210 | 2, sizeof(MotorStatus_t), (uint8_t*)&fuel_press.status);
        }
        if (time_millis() - last_2Hz_time > 500) {
            ...
            can_txq_push(0x400 | 2, sizeof (Heartbeat_t), (uint8_t*)&hb);
        }
    }
}
