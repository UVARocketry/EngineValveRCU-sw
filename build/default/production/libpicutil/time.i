...
# 2 "<built-in>" 2
# 1 "libpicutil/time.c" 2
# 1 "libpicutil/time.h" 1
# 11 "libpicutil/time.h"
...
void __attribute__((picinterrupt(("irq(31)")))) TMR0_int() {
    PIR3bits.TMR0IF = 0;
